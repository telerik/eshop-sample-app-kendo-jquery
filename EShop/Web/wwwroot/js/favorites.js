function addProductToFavorites(e) {
    ...
    var getUrl = window.location.href.indexOf('eshop') > 0 ? "/eshop/Account/ProductIsInFavorites?productId=" : window.location.origin + "/Account/ProductIsInFavorites?productId=";
    var addUrl = window.location.href.indexOf('eshop') > 0 ? "/eshop/Account/AddProductToFavorites?productId=" : window.location.origin + "/Account/AddProductToFavorites?productId=";
    var removeUrl = window.location.href.indexOf('eshop') > 0 ? "/eshop/Account/RemoveProductFromFavorites?productId=" : window.location.origin + "/Account/RemoveProductFromFavorites?productId=";
...
function getFavoritesCount() {
    var getUrl = window.location.href.indexOf('eshop') > 0 ? "/eshop/Account/GetFavoritesCount" : window.location.origin + "/Account/GetFavoritesCount";
